<script setup>
import { getCategory, putCategory, deleteCategory } from '@/backendService';
...
<template>
  ...
  <form>
    ...
    <div>
      <button type="button" class="btn lg" @click="updateCategory">저장</button>
      <button type="button" class="btn lg" @click="delCategory">삭제</button>
