...
<template>
  ...
  <form>
    ...
    <div>
      <label>수량</label>
      <input type="phone" v-model="product.quantity" />
    </div>
    <div>
      <label>카테고리</label>
...
<style scoped>
form { font-size: 11pt; display: grid; grid-template-columns: 1fr 1fr; gap:1em;}
h1 { border-bottom: 1px solid gray; }
div { margin-top: 1.5em; }
label:nth-child(1) { display: inline-block; width: 4em; text-align: right; margin-right: 1em; }
